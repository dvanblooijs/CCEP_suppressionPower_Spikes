...
for nSubj = 1:size(cfg,2)
    ...
    dataBase(nSubj).ERSP = load(fullfile(myDataPath.proj_diroutput,'ERSP', dataBase(nSubj).sub_label,...
        dataBase(nSubj).ses_label,dataBase(nSubj).run_label,...
...
if exist(fullfile(myDataPath.proj_diroutput,'ERSP', dataBase(nSubj).sub_label, dataBase(nSubj).ses_label, dataBase(nSubj).run_label,...
    ...
    dataBase(nSubj).ERSPdet = load(fullfile(myDataPath.proj_diroutput,'ERSP', dataBase(nSubj).sub_label,dataBase(nSubj).ses_label, dataBase(nSubj).run_label,...
        [dataBase(nSubj).sub_label, '_', dataBase(nSubj).ses_label,'_',dataBase(nSubj).task_label,'_',dataBase(nSubj).run_label,'_ERSPdet.mat']));

    fprintf('Loading %s  \n',...
        fullfile(myDataPath.proj_diroutput,'ERSP', dataBase(nSubj).sub_label,dataBase(nSubj).ses_label, dataBase(nSubj).run_label,...
        [dataBase(nSubj).sub_label, '_', dataBase(nSubj).ses_label,'_',dataBase(nSubj).task_label,'_',dataBase(nSubj).run_label,'_ERSPdet.mat']))
